...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sbtab-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11250&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sbtab-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sbtab` can be installed with:

```
conda install sbtab
```

It is possible to list all of the versions of `sbtab` available on your platform with:
